...
where \\(R_{surf}\\) (mm H2O) is the estimated surface runoff, \\(Thrf\\) (mm H2O) is the throughfall, \\(W_0\\) (mm H2O) is the initial soil moisture content, \\(W_m\\) (mm H2O) is the maximum soil moisture content, \\(i_0\\) (mm H2O) is the initial infiltration rate,  \\(i_m\\) (mm H2O) is the maximum infiltration rate. 
